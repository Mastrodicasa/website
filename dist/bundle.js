...
var _zenscroll = __webpack_require__(94);

var _zenscroll2 = _interopRequireDefault(_zenscroll);

var _mobileMenu = __webpack_require__(95);

var _mobileMenu2 = _interopRequireDefault(_mobileMenu);

var _imgSwap = __webpack_require__(96);

var _imgSwap2 = _interopRequireDefault(_imgSwap);
...
// loadIntroVideo
//var introVideo = (0, _bling.$)(".divider__gif-01");
//introVideo.src = "https://s3.amazonaws.com/harrydry/steve/steve__01.mp4";

_zenscroll2.default.setup(null, 0);

// import menuHide from "./modules/menuHide";

var menuItems = [].concat((0, _toConsumableArray3.default)((0, _bling.$$)(".leftmenu__item")));
var dividers = [].concat((0, _toConsumableArray3.default)((0, _bling.$$)(".divider")));
...
menuItems.forEach(function (item, index) {
  item.on("click", function () {
    ...
    _zenscroll2.default.to(dividers["" + nom], 0);
    if (index > 6) {
...
if (window.innerWidth <= 1023) {
  (0, _bling.$)(".mobileMenuOuter").on("click", _mobileMenu2.default);
}

if (window.innerWidth < 1200) {
  var fullWidthArray = (0, _from2.default)((0, _bling.$$)(".fullWidth"));
  fullWidthArray.forEach(function (img) {
...
var mailCheck1 = (0, _bling.$)(".mc1");
var mailSubmitted1 = (0, _bling.$)(".pis1");
var mailInput1 = (0, _bling.$)(".pii1");
var mailNotValid1 = (0, _bling.$)(".pinv1");

mailCheck1.on("click", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
  var res;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _axios2.default.post("/subscribe", {
...
var mailCheck2 = (0, _bling.$)(".mc2");
var mailSubmitted2 = (0, _bling.$)(".pis2");
var mailInput2 = (0, _bling.$)(".pii2");
var mailNotValid2 = (0, _bling.$)(".pinv2");

mailCheck2.on("click", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
  var res;
...
// }
function toggleMenu() {
  (0, _bling.$)(".mobilemenu").classList.toggle("mobilemenu__active");
  (0, _bling.$)("body").classList.toggle("noScroll");
  (0, _bling.$)("html").classList.toggle("noScroll");
  (0, _bling.$)(".mobileMenuOpen").classList.toggle("mobileMenuOpen__on");
}
...
function imgSwap() {
  if (window.innerWidth < 1000) {
    (0, _bling.$)(".disIMG").src = "https://s3.amazonaws.com/harrydry/disMob.png";
    (0, _bling.$)(".hunterIMG").src = "https://s3.amazonaws.com/harrydry/hunterMob.png";
    (0, _bling.$)(".bamn1").src = "https://s3.eu-west-2.amazonaws.com/yeezydating/bamn/bamnmob1.jpg";
    (0, _bling.$)(".bamn3").src = "https://s3.eu-west-2.amazonaws.com/yeezydating/bamn/bamnmob3.jpg";
    (0, _bling.$)(".closerIMG").src = "https://s3.eu-west-2.amazonaws.com/yeezydating/bamn/closerSmaller.png";
  }
}

exports.default = imgSwap;
...
var dividers = (0, _from2.default)((0, _bling.$$)(".divider"));
var dividerHeight = dividers[0].offsetHeight;
var menuToTop = (0, _bling.$)("." + mobOrLeft).getBoundingClientRect().top;
...
function updateCoords() {
  ...
  menuToTop = (0, _bling.$)("." + mobOrLeft).getBoundingClientRect().top;
}
...
function isChapterRead() {
  ...
  dividers.forEach(function (divider, index) {
    if (index > 0) {
      var lm = (0, _bling.$)("." + mobOrLeft + " > .lm00" + index.toString());
    ...
    if (index === 6) {
      var lm = (0, _bling.$)("." + mobOrLeft + " > .lm007");
      var endPlug = (0, _bling.$)(".endPlug");
      if (endPlug.getBoundingClientRect().top - endPlug.offsetHeight < -endCounter) {
        lm.classList.add("strike");
      } else {
        lm.classList.contains("strike") ? lm.classList.remove("strike") : null;
      }
...
var freshOuter = (0, _bling.$)(".fresh");
var freshImg1 = (0, _bling.$)(".fresh__img1");
var freshImg2 = (0, _bling.$)(".fresh__img2");
// mon
var freshImg1Mob = (0, _bling.$)(".fresh__img1Mob");
var freshImg2Mob = (0, _bling.$)(".fresh__img2Mob");
var freshImg3Mob = (0, _bling.$)(".fresh__img3Mob");

var freshtest = (0, _bling.$)(".fresh__test");
...
if (window.innerWidth > 500) {
  _promise2.default.all([loadImage("sharper.png"), loadImage("https://s3.amazonaws.com/harrydry/harry1.png")]).then(function () {
    var freshImgHeight = freshImg1.offsetHeight;
    var windowHeight = freshtest.clientHeight;
    setTimeout(function () {
      return freshImg1.style.top = "-" + (freshImgHeight - windowHeight) + "px";
    }, 600);
  }).catch(function (e) {
    return console.log(e);
  });
  freshImg1.addEventListener("transitionend", function (event) {
    setTimeout(function () {
...
if (window.innerWidth < 500) {
  _promise2.default.all([loadImage("sharper.png"), loadImage("sharper.png"), loadImage("https://s3.amazonaws.com/harrydry/harryMob2.png"), loadImage("https://s3.amazonaws.com/harrydry/harryMob3.png")]).then(function () {
    setTimeout(function () {
  ...
  freshImg1Mob.addEventListener("transitionend", function (event) {
    setTimeout(function () {
      freshImg2Mob.style.opacity = "1";
    }, 100);
  });
  freshImg2Mob.addEventListener("transitionend", function (event) {
    setTimeout(function () {
